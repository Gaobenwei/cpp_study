...
[C++默认实参剖析 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/588948013)

未学习：C++11用户定义字面量，lambda剖析
...
- [rb_tree](./src_analysis/stl/rb_tree.md)    未学习
...
- [自己动手，实现 C++ 的智能指针](./learn_class/modern_cpp_30/smart_ptr)        (难点)
...
- [右值和移动究竟解决了什么问题？](./learn_class/modern_cpp_30/reference) （没有说明文档，仅仅看懂代码）
...
- [容器 1](./learn_class/modern_cpp_30/container1)  （于9.1一样 未学习）
- [容器 2](./learn_class/modern_cpp_30/container2)
- [异常](./learn_class/modern_cpp_30/exception)
- [字面量、静态断言和成员函数说明符](./learn_class/modern_cpp_30/literalAssert)  (字面量为学习，断言未学习)
- [是不是应该返回对象？](./learn_class/modern_cpp_30/returnObj)
- [编译期多态：泛型编程和模板入门](./learn_class/modern_cpp_30/compilerpoly)
- [译期能做些什么？一个完整的计算世界](./learn_class/modern_cpp_30/compilercompute) (模板的应用 没学好，模板实现循环 难点)
- [SFINAE：不是错误的替换失败是怎么回事?](./learn_class/modern_cpp_30/SFINAE)  （未学习）
- [constexpr：一个常态的世界](./learn_class/modern_cpp_30/constexpr) 
- [函数对象和 lambda：进入函数式编程](./learn_class/modern_cpp_30/functionLambda) （autoLambda 未学习）
- [内存模型和 atomic：理解并发的复杂性](./learn_class/modern_cpp_30/memorymodel_atomic) （未学习）
